...
test_real_graph_generation(initial_graph, functions_list, iterations=20, folder='results_ada_lingam_20_noise_20_iter', dataset_class=AdaByronData, nalingam_score_iterations=10, nalingam_graph_iterations=1)